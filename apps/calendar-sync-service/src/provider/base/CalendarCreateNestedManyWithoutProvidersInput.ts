...
@InputType()
class CalendarCreateNestedManyWithoutProvidersInput {
...
export { CalendarCreateNestedManyWithoutProvidersInput as CalendarCreateNestedManyWithoutProvidersInput };
