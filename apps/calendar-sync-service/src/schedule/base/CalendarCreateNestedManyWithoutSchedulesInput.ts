...
@InputType()
class CalendarCreateNestedManyWithoutSchedulesInput {
...
export { CalendarCreateNestedManyWithoutSchedulesInput as CalendarCreateNestedManyWithoutSchedulesInput };
